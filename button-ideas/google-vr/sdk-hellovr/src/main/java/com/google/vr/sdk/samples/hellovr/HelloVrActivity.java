...
public class HelloVrActivity extends GvrActivity implements GvrView.StereoRenderer {
  ...
  public void onCardboardTrigger() {
    ...
    if (isLookingAtTarget()) {
      ...
      Log.i(TAG, "onCardboardTrigger .. about to push the button");
      this.pushTheButton(4);
  ...
  private void pushTheButton(int buttonNumber) {
    HttpUtils.post( "buttons/" + buttonNumber, null, new JsonHttpResponseHandler() {
      @Override
